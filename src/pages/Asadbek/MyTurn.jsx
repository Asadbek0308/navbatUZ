                  ...
                  {displayedHistory.map((item) => (
                    <tr key={item.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-900/30 transition">
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-block rounded px-2.5 py-1 text-[10px] font-extrabold ${item.status === "BAJARILDI" ? "bg-emerald-100 text-emerald-800 dark:bg-emerald-950/60" : "bg-red-100 text-red-800"
                          }`}>{item.status}</span>
                      </td>
                    </tr>
                  ))}
