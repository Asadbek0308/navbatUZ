...
[out:json];
(
node["amenity"="fuel"](41.20,69.10,41.40,69.40);
);
out;
`;
        ...
        {!selected ? (
          <div className="flex h-full flex-col items-center justify-center text-center">
            ...
            <p className="mt-2 text-slate-400">
              Xaritadagi marker ustiga bosing.
            </p>
          </div>
        ) : (
          <div className="h-full text-white">
            ...
            <div className="space-y-2">
              ...
              {Object.entries(getFuelPrices(selected.id)).map(
                ([key, value]) => (
                  <div
                    key={key}
                    className="flex justify-between rounded-lg bg-slate-900 px-4 py-2"
                  >
            ...
            {booking && (
              <div className="mt-5 rounded-lg border border-green-600 bg-green-950 p-4">
                <h3 className="font-bold text-green-400">
                  Band qilindi ✅
                </h3>

                <p>Zapravka: {booking.station.name}</p>
                <p>Yoqilg‘i: {booking.fuel.toUpperCase()}</p>
                <p>
                  Narx: {booking.price.toLocaleString()} so‘m
                </p>
                ...
                <button
                  ...
                  className="mt-3 w-full rounded bg-red-600 py-2 hover:bg-red-700"
                >
                  Bekor qilish
                </button>
              </div>
